...
Currently working at the intersection of Generative AI and real-world automation, I aspire to contribute to a world where technology empowers and inspires.

`Agentic AI` · `Computer Vision` · `LLMs & RAG` · `MLOps` · `Python`
